export const data={
 ...
 items:[
  {yep:true,text:'Semen, авто. Выезд от Красногвардейской, 3 места.',err:'При любом поиске чем больше людей, тем лучше.',audio:'voice1',mini:{index:4,type:'foot'}},
  {text:'Сорри, ребят, в душе я с вами.',err:'К сожалению, погряз в пробках.',audio:'voice0'},
  {yep:true,text:'Оболенская, выезжаю из Балашихи, авто 3 места. При стопе позвоните.',err:'При любом поиске чем больше людей, тем лучше.',audio:'voice3',mini:{index:2,type:'foot'}},
  ...
  {yep:true,text:'Ежик с котомкой и Bigden готовы стартовать от метро Орехово.',err:'При любом поиске чем больше людей, тем лучше.',audio:'voice5',mini:{index:8,type:'foot'}},
  {yep:true,text:'Это Vert. Буду ко времени, есть 4 места для пеших.',err:'Да куда ж ты от меня денешься, я же здесь.',audio:'voice6',mini:{index:5,type:'foot'}},
  ...
  {yep:true,text:'Тамада, готов на авто, подберу пеших. Три места свободных.',err:'При любом поиске чем больше людей, тем лучше.',audio:'voice8',mini:{index:7,type:'foot'}},
  ...
  {yep:true,text:'Камбоджо, выдвигаюсь. 2-3 места свободных есть.',err:'При любом поиске чем больше людей, тем лучше.',audio:'voice12',mini:{index:1,type:'foot'}},
